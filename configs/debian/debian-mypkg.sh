...
pkg_multimedia='vlc cdparanoia ripperx flac libdvdread4 darktable mesa-utils mencoder fswebcam shntool mkcue sox ffmpeg'
pkg_recording='jackd qjackctl multimedia-firewire ardour calf-plugins hydrogen hydrogen-drumkits hydrogen-drumkits-effects zynaddsubfx x42-plugins qsynth zam-plugins vlc-plugin-jack pulseaudio-module-jack vmpk'
