...
pkg_devel='vim git tig gdb ddd pylint python-pip exuberant-ctags gcc g++ build-essential autoconf automake autotools-dev fakeroot libncurses5-dev ncurses-base pgadmin3 virtualenv cmake puppet-lint python-pylint-django libc6-dev-i386'
...
pkg_multimedia='vlc cdparanoia ripperx flac libdvdread4 darktable mesa-utils mencoder fswebcam imagemagick shntool mkcue sox ffmpeg'
pkg_recording='jackd qjackctl multimedia-firewire ardour calf-plugins hydrogen hydrogen-drumkits hydrogen-drumkits-effects zynaddsubfx x42-plugins qsynth zam-plugins vlc-plugin-jack jack-keyboard pulseaudio-module-jack vmpk'
